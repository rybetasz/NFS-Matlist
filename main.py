...
def txtduzenleme():
    ...
    enda.configure(fg="Yellow",bg="Black",font=("Microsoft Sans Serif" , 18 , "bold"))
...
om.pack()
om.configure(bg="black",fg="yellow" , font=("Arial",20,"bold"))

caller_button = Button(text="Düzenle", font=("Microsoft Sans Serif", 32, "bold"), command=lambda: picker())
caller_button.configure(bg="black",fg="yellow")
